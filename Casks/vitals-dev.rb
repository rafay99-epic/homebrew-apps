cask "vitals-dev" do
  ...
  name "Vitals Dev"
  desc "Discontinued Dev channel of the Vitals hardware monitor"
  ...
  deprecate! date:    "2026-06-17",
             because: "the Dev channel is now Nightly — install rafay99-epic/apps/vitals-nightly instead"
  ...
  postflight_steps do
    run "/usr/bin/xattr", args: ["-dr", "com.apple.quarantine", "{{appdir}}/Vitals Dev.app"]
  end
